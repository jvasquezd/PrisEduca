        ...
        <div class="container">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="text-white">
                    ...
                    <p class="mb-1"><i class="fas fa-chart-line"></i> Nivel: {{$course->level->name}}</p>
                    <p class="mb-1"><i class=""></i> Categoria: {{$course->category->name}}</p>
                    ...
                    <div class="card-body">
                        <div class="flex items-center">
                            <figure class="flex-shrink-0 mr-4">
                                <img class="h-12 w-12 object-cover rounded-full shadow" src="{{ $course->instructor->profile_photo_url }}" alt="{{ $course->instructor->name }}">
                            </figure>
                            <div>
                                <h1 class="font-bold text-gray-500">Prof. {{ $course->instructor->name }}</h1>
                                <a class="text-gray-400 text-sm" href="">{{ '@' . Str::slug($course->instructor->name, '') }}</a>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 mr-1">
                                        <img class="h-6 w-6 object-cover rounded-full" src="{{ $alike->instructor->profile_photo_url }}" alt="{{ $alike->instructor->name }}">
                                    </div>
                                    <div>
                                        <h1 class="text-xs font-bold text-gray-500">Prof. {{ $alike->instructor->name }}</h1>
                                    </div>
                                </div>
