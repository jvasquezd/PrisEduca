<div class="container py-8">
    ...
    <x-table-responsive>
        <div class="px-4 py-4 flex">
            <input wire:keydown="clear_page" wire:model="search" class="form-input block flex-1 shadow-sm" placeholder="Ingrese el nombre de un curso">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                @foreach($courses as $course)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{$course->subscribers->count()}}</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @switch($course->status)
                                ...
                                @break
                                @case(2)
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-300 text-yellow-800">Revision</span>
                                @break
                                @case(3)
        ...
        @else
            <div class="px-6 py-4">
                No hay ningun registro de coincida con su busqueda
            </div>
        @endif
