    ...
    <div class="container py-12 grid md:grid-cols-5 md:gap-8">
        <aside>
            <ul class="mb-8">
                ...
                <li>
                    <a class="block px-4 py-2 mb-1 border-l-4 @routeIs('instructor.courses.subscribers', $course) text-blue-700 bg-blue-100 hover:bg-blue-200 border-blue-400 @else text-gray-600 hover:bg-gray-200 border-transparent @endif" href="{{ route('instructor.courses.subscribers', $course) }}">Estudiantes</a>
                </li>
